###数据库ER图 
![alt text](https://github.com/09143573/mis/blob/master/1.PNG "Title")
###建表
     CREATE TABLE `设备类型` (
...
###查询
 (1)根据设备ID查询保养记录
  ...
  ![alt text](https://github.com/09143573/mis/blob/master/2.PNG "Title")
  
  select * from 设备 as a inner join 保养记录 as b on a.设备ID=b.设备ID where a.设备ID="1"
  
  ![alt text](https://github.com/09143573/mis/blob/master/3.PNG "Title")）
  
(2)根据设备ID打印检修报告
  select * from 设备 as a inner join 保养记录 as b on a.设备ID=b.设备ID left join 保养消耗as c on b.保养记录ID=c.保养记录ID where a.设备ID="1"  
  
 ![alt text](https://github.com/09143573/mis/blob/master/4.PNG "Title")
